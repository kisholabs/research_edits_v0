...
Both the Ridge and LASSO regression models achieved a near identical fit to the velocity field, achieving $R^{2}$ values of 0.999 and 0.985 respectively. The model predicted plotted against the ground truth velocity field has been shown in Figure \ref{Fig:Data4}, highlighting the accuracy of the predictions. (still finishing) (talk about next experiment to verify accuracy and then talk about figure 5) (insert basal traction conversion formula)
