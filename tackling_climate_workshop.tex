...
\begin{figure}[!htb]
   ...
   \begin{minipage}{0.33\textwidth}
    ...
    \end{tabular}
    \caption{Interpolation for Data 3}\label{Fig:Data3}
  \end{minipage}
\end{figure}
